<div class="relative z-10" aria-labelledby="modleEditSubjectUser_{{ $subject->id }}_{{ $subjectUser->id }}" role="dialog" aria-modal="true">
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button type="button" id="editSubject"
                        data-subjectId="{{ $subject->id }}" data-subjectUserId="{{ $subjectUser->id }}"

...
@section('content_admin')
    <div class="flex-grow p-4  container mt-4">
        ...
        <table id="user_table" class="w-full border-collapse border border-gray-300">
            <thead>
                <tr class="">
                    ...
                    <th class="px-4 py-2 text-sm font-semibold text-gray-900 bg-gray-100">Status</th>
                </tr>
            </thead>
        ...
        <div id="CreatUser" class="hidden fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
